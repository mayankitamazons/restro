(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendor-manager-vendor-manager-module"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VendorDetailResolver = /** @class */ (function () {
                ...
                VendorDetailResolver.prototype.resolve = function (route, _state) {
                    ...
                    return this.vendorManagerService.getVendor(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["empty"])();
                    }));
                };
                return VendorDetailResolver;
            }());
            VendorDetailResolver.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserFormComponent = /** @class */ (function () {
                function UserFormComponent(router, formBuilder, vendorService) {
                    this.router = router;
                    ...
                    if (this.operation == 'UPDATE') {
                        this.vendorService.updateVendor(this.vendorForm.value)
                            ...
                            next: function (data) {
                                ...
                                _this.router.navigate(['/vendor/detail', _this.vendor['_id']]);
                            },
                            error: function (data) {
                                console.log('data: ', data);
                                _this.progressing = false;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserListComponent = /** @class */ (function () {
                function UserListComponent(vendorManagerService, ModalService) {
                    this.vendorManagerService = vendorManagerService;
                ...
                UserListComponent.prototype.deleteVendor = function (vendor) {
                    ...
                    Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["from"])(modalRef.result)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (data) { return data; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.ngUnsubcribe))
                        .subscribe(function () { return _this.vendorManagerService.getVendorList(); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var VendorManagerService = /** @class */ (function () {
                function VendorManagerService(vendorService) {
                    this.vendorService = vendorService;
            ...
            VendorManagerService.ctorParameters = function () { return [
...
//# sourceMappingURL=vendor-manager-vendor-manager-module-es5.js.map
//# sourceMappingURL=vendor-manager-vendor-manager-module-es5.js.map