...
let StaffDetailResolver = class StaffDetailResolver {
    constructor(staffManagerService) {
        this.staffManagerService = staffManagerService;
    }
    resolve(route, _state) {
        console.log('router', route.params);
        return this.staffManagerService.getStaff(route.params['id']).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((error) => {
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["empty"])();
        }));
    }
};
StaffDetailResolver.ctorParameters = () => [
...
let StaffManagerService = class StaffManagerService {
    constructor(staffService, vendorService) {
...
StaffManagerService.ctorParameters = () => [
...
let UserFormComponent = class UserFormComponent {
    constructor(router, formBuilder, staffService) {
        this.router = router;
...
let UserListComponent = class UserListComponent {
    constructor(staffManagerService, ModalService) {
        this.staffManagerService = staffManagerService;
    ...
    deletestaff(staff) {
        ...
        Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(modalRef.result)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["filter"])((data) => data), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["takeUntil"])(this.ngUnsubcribe))
            .subscribe(() => this.staffManagerService.getStaffList());
    }
};
